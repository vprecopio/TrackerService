<div class="flex flex-col items-center justify-center min-h-screen p-4 space-y-4 antialiased text-gray-900 bg-gray-100">
        ...
        <main>
            <div class="bg-white shadow-xl p-10 flex flex-col gap-6 text-sm w-96">
                ...
                <div class="mb-2">
                    <input class="border border-gray-400 focus:outline-[#06b6d4] rounded-md w-full shadow-sm px-5 py-2" type="password" name="password" placeholder="Confirma tu contraseña" autocomplete="off"/>
                </div>
                <div class="mb-2">
