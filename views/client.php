                ...
                <div class="w-full mb-1">
                    ...
                    <div class="items-center justify-between block sm:flex">
                        ...
                        <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                            <a type="button" href="/client/" type="button" data-refresh="" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                            ...
                            <button id="createProductButton" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" type="button" data-drawer-target="crear-cliente" data-drawer-show="crear-cliente" aria-controls="crear-cliente" data-drawer-placement="right">
                                    ...
                                    <?php foreach ($client_controller->ListClient() as $obj_client) : ?>
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td class="p-4 space-x-2 whitespace-nowrap">
                                                ...
                                                <button type="button" id="updateclienteButton" onclick="llenarFormularioCliente('<?php echo $obj_client->id_cliente; ?>','<?= $obj_client->cliente_nombre ?>', '<?= $obj_client->cliente_email ?>', '<?= $obj_client->cliente_telefono ?>', '<?= $obj_client->cliente_direccion ?>');" data-drawer-target="drawer-update-cliente-default" data-drawer-show="drawer-update-cliente-default" aria-controls="drawer-update-cliente-default" data-drawer-placement="right" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
