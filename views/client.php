...
<div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
    <div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900 min-h-screen">
        <entities-crud type="products">
                ...
                <div class="w-full mb-1">
                    ...
                    <div class="items-center justify-between block">
                        ...
                        <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                            <a type="button" href="/client/" data-refresh="" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-black rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                            ...
                            <button id="createProductButton" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-black rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" type="button" data-drawer-target="crear-cliente" data-drawer-show="crear-cliente" aria-controls="crear-cliente" data-drawer-placement="right">
                                    ...
                                    <?php foreach ($client_controller->ListClient() as $obj_client) : ?>
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td class="p-4 space-x-2 whitespace-nowrap">
                                                ...
                                                <button type="button" onclick="window.location.href = '/client/edit/?id=<?php echo $obj_client->id_cliente; ?>';" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300">
                                                ...
                                                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="/client/delete/?Documento=<?php echo $obj_client->id_cliente; ?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300">
                                                    <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Edit Product Drawer -->
            <div id="drawer-update-product-default" class="fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform bg-white dark:bg-gray-800 translate-x-full" tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
