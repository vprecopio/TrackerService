                            ...
                            <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Clientes</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                                    ...
                                    <?php foreach ($client_controller->ListClient() as $obj_client) : ?>
                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td class="p-4 space-x-2 whitespace-nowrap w-1/5">
                                                ...
                                                <button type="button" id="deleteClientButton" data-client-id="<?php echo $obj_client->id_cliente; ?>" data-drawer-target="drawer-delete-client-default" data-drawer-show="drawer-delete-client-default" aria-controls="drawer-delete-client-default" data-drawer-placement="right" class="inline-flex items-center px-3 py-2 text-sm font-bold text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
                                                    <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
<script>
    //script eliminar cliente button
